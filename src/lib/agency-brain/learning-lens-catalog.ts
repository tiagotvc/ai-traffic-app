...
export const LEARNING_LENS_CATALOG: LearningLensEntry[] = [
  {
    ...
    activeBg: "bg-[var(--surface-thead)]",
    activeText: "text-[var(--text-main)]",
    iconBg: "bg-[var(--surface-thead)]0/10",
  ...
  },
  {
    ...
    activeBg: "bg-[rgba(124,58,237,0.06)]0/10",
    activeText: "text-[var(--violet)]",
    iconBg: "bg-[rgba(124,58,237,0.06)]0/15",
