...
const pt: LegalPageContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Gestão de clientes e contas de anúncios",
        "Integrações com plataformas de marketing",
        "Recursos de automação e funcionalidades adicionais disponibilizadas futuramente"
      ]
    },
    {
      ...
      bullets: [
        ...
        "Atua em nome próprio ou possui autorização para representar pessoa jurídica",
        "Fornecerá informações verdadeiras, completas e atualizadas",
        "Não utilizará a plataforma para finalidades ilícitas"
      ]
    },
    {
    ...
    },
    {
      title: "6. Pagamentos",
      paragraphs: [
        "Os pagamentos poderão ser processados por terceiros especializados.",
        "Ao contratar um plano pago, o usuário concorda que os valores informados serão cobrados conforme o plano selecionado, tributos eventualmente incidentes poderão ser adicionados quando exigidos por lei, e o não pagamento poderá resultar em suspensão ou cancelamento do acesso.",
        "O usuário é responsável por manter seus dados de cobrança atualizados."
      ]
    },
    {
      title: "7. Renovação Automática",
      paragraphs: [
        "Salvo indicação em contrário, as assinaturas serão renovadas automaticamente ao final de cada período contratado.",
        "O usuário poderá cancelar a renovação a qualquer momento antes da próxima cobrança.",
        "O cancelamento impede cobranças futuras, mas não gera reembolso proporcional de períodos já faturados, exceto quando exigido pela legislação aplicável."
      ]
    },
    {
    ...
    },
    {
      ...
      paragraphs: ["O usuário concorda em utilizar a plataforma exclusivamente para fins legítimos e em conformidade com a legislação vigente."],
      bullets: [
        "Gerenciar campanhas próprias",
        "Gerenciar campanhas de clientes autorizados",
        "Utilizar análises para tomada de decisão",
        "Exportar dados disponibilizados pela plataforma"
      ]
    },
    {
      title: "12. Restrições de Uso",
      paragraphs: [
        "É proibido utilizar a plataforma para fins ilegais, tentar acessar áreas restritas, compartilhar credenciais indevidamente, realizar engenharia reversa, copiar funcionalidades, sobrecarregar a infraestrutura ou violar direitos de terceiros.",
      ...
      bullets: [
        ...
        "Compartilhar credenciais de forma não autorizada",
        "Realizar engenharia reversa ou copiar funcionalidades",
        "Utilizar robôs para sobrecarregar a infraestrutura",
        "Interferir no funcionamento dos serviços ou violar direitos de terceiros"
      ]
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Estes Termos de Uso serão regidos pelas leis da República Federativa do Brasil, incluindo o Código Civil, o Código de Defesa do Consumidor e a Lei Geral de Proteção de Dados Pessoais (LGPD — Lei nº 13.709/2018).",
        "As partes envidarão esforços para resolver amigavelmente divergências decorrentes da utilização da plataforma.",
        "Não sendo possível solução amigável, fica eleito o foro da Comarca de Novo Hamburgo, Estado do Rio Grande do Sul, salvo disposições legais em favor do consumidor ou titular de dados pessoais."
      ]
    },
    {
      title: "21. Contato",
      paragraphs: [
        "Dúvidas, solicitações ou reclamações relacionadas a estes Termos poderão ser encaminhadas pelos canais oficiais:",
        `Suporte: ${LEGAL_CONTACT.supportEmail}`,
        `Privacidade e LGPD: ${LEGAL_CONTACT.privacyEmail}`,
  ...
  footerNote: `Dúvidas sobre estes termos? Escreva para ${LEGAL_CONTACT.privacyEmail}.`
};
...
const en: LegalPageContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Performance alerts",
        "Change history",
        "Client and ad account management",
        "Marketing platform integrations",
        "Automation and future features"
      ]
    },
    {
      title: "3. Eligibility",
      ...
      bullets: [
        ...
        "You act on your own behalf or are authorized to represent a legal entity",
        "You will provide true, complete, and up-to-date information",
    ...
    },
    {
      title: "6. Payments",
      paragraphs: [
        "Payments may be processed by specialized third parties.",
        "By subscribing to a paid plan, you agree that charges will follow the selected plan, applicable taxes may be added when required by law, and non-payment may result in suspension or cancellation.",
        "You are responsible for keeping billing information up to date."
      ]
    },
    {
      title: "7. Automatic Renewal",
      paragraphs: [
        "Unless stated otherwise, subscriptions renew automatically at the end of each billing period.",
        "You may cancel renewal before the next charge.",
        "Cancellation prevents future charges but does not refund already billed periods, except when required by applicable law."
      ]
    },
    {
    ...
    },
    {
      ...
      paragraphs: ["You agree to use the platform only for lawful purposes and in compliance with applicable law."],
      bullets: [
        "Manage your own campaigns",
        "Manage authorized client campaigns",
        "Use analytics for decision-making",
        "Export data made available by the platform"
      ]
    },
    {
      title: "12. Use Restrictions",
      paragraphs: [
        "You may not use the platform unlawfully, attempt unauthorized access, share credentials improperly, reverse engineer, copy features, overload infrastructure, or violate third-party rights.",
        "Violations may result in immediate suspension or termination."
      ],
      bullets: [
        "Unlawful use",
        "Unauthorized access attempts",
        "Improper credential sharing",
        "Reverse engineering or copying features",
        "Using bots to overload infrastructure",
        "Interfering with services or violating third-party rights"
      ]
    },
    {
      title: "13. User Data",
    ...
    },
    {
      ...
      paragraphs: [
        "These Terms are governed by the laws of Brazil, including the Civil Code, Consumer Defense Code, and LGPD (Law No. 13,709/2018).",
        "Parties will seek amicable resolution of disputes arising from use of the platform.",
        "If amicable resolution is not possible, venue is the courts of Novo Hamburgo, Rio Grande do Sul, Brazil, except where consumer or data-subject protections require otherwise."
      ]
    },
    {
      title: "21. Contact",
      paragraphs: [
        "Questions, requests, or complaints regarding these Terms may be sent through official channels:",
        `Support: ${LEGAL_CONTACT.supportEmail}`,
        `Privacy & LGPD: ${LEGAL_CONTACT.privacyEmail}`,
        `Sales: ${LEGAL_CONTACT.commercialEmail}`
      ]
    },
    {
  ...
  footerNote: `Questions about these terms? Email ${LEGAL_CONTACT.privacyEmail}.`
};

export const termsContent: Record<LegalLocale, LegalPageContent> = { "pt-BR": pt, en };

export function getTermsContent(locale: string): LegalPageContent {
  return termsContent[locale === "en" ? "en" : "pt-BR"];
}
