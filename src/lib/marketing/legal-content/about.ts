...
const pt: LegalPageContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        "Monitorar campanhas em um único lugar",
        "Visualizar métricas de forma simples",
        "Identificar oportunidades de otimização",
        "Receber alertas automáticos",
        "Gerar aprendizados sobre campanhas",
        "Acompanhar histórico de desempenho",
        "Receber recomendações geradas por IA",
        "Economizar tempo em análises manuais"
      ]
    },
    {
      title: "Nossa visão",
    ...
    },
    {
      ...
      paragraphs: ["Operamos com quatro princípios:"],
      bullets: [
        "Simplicidade — tecnologia complexa deve gerar experiências simples",
        "Transparência — relações claras com clientes, parceiros e usuários",
        "Inovação — explorar IA para gerar valor real",
        "Resultado — cada funcionalidade deve apoiar decisões melhores",
        "Evolução contínua — a plataforma evolui junto com o mercado"
      ]
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Nos comprometemos a desenvolver uma plataforma confiável, segura e alinhada às melhores práticas do mercado.",
        "Investimos continuamente em segurança da informação, privacidade dos dados, confiabilidade das integrações, inteligência artificial responsável e melhoria da experiência do usuário.",
        "Sabemos que nossos clientes confiam informações importantes à plataforma e levamos essa responsabilidade a sério."
      ]
    },
    {
      title: "Integrações",
    ...
    },
    {
      title: "Conformidade",
      paragraphs: [
        "Operamos em conformidade com a LGPD (Lei nº 13.709/2018).",
        "Você pode solicitar acesso, correção, portabilidade ou exclusão dos seus dados pessoais pelo e-mail " + LEGAL_CONTACT.privacyEmail + ".",
        "Consulte também nossa Política de Privacidade e as instruções de exclusão de dados."
      ]
    },
    {
...
const en: LegalPageContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        "Monitor campaigns in one place",
        "View metrics simply",
    ...
    {
      title: "Our values",
      paragraphs: ["We operate on these principles:"],
      bullets: [
        "Simplicity — complex technology should feel simple",
        "Transparency — clear relationships with users and partners",
        "Innovation — using AI to create real value",
        "Results — every feature should support better decisions",
        "Continuous evolution — the platform grows with the market"
      ]
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "We are committed to a reliable, secure platform aligned with market best practices.",
        "We continuously invest in information security, data privacy, integration reliability, responsible AI, and user experience.",
        "We take seriously the trust our customers place in the platform."
      ]
    },
    {
      title: "Integrations",
    ...
    },
    {
      title: "Compliance",
      paragraphs: [
        "We operate in compliance with Brazil's LGPD (Law No. 13,709/2018).",
        `You may request access, correction, portability, or deletion of personal data at ${LEGAL_CONTACT.privacyEmail}.`,
        "See our Privacy Policy and Data Deletion Instructions for details."
      ]
    },
    {
      title: "The future",
...
export const aboutContent: Record<LegalLocale, LegalPageContent> = { "pt-BR": pt, en };

export function getAboutContent(locale: string): LegalPageContent {
  return aboutContent[locale === "en" ? "en" : "pt-BR"];
}
