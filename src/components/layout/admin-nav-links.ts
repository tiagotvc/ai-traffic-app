export const PLATFORM_ADMIN_LINKS = [
  ...
  { id: "funnel", href: "/admin/billing/funnel", labelKey: "navFunnel" as const },
  { id: "subscriptions", href: "/admin/billing/subscriptions", labelKey: "navSubscriptions" as const },
  ...
  { id: "emailLogs", href: "/admin/email-logs", labelKey: "navEmailLogs" as const },
