...
import BrainShelf from "@/components/BrainShelf";
import MetricPrism from "@/components/MetricPrism";
import PerformanceChart from "@/components/PerformanceChart";
import LiveIntelligenceFeed from "@/components/LiveIntelligenceFeed";
import AgencyHealthLayout from "@/components/AgencyHealthLayout";
        ...
        <main className="flex-1 overflow-y-auto px-4 md:px-6 py-5 space-y-4"
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              style={
                !isEmptyState
                  ? { background: "rgba(245,166,35,0.1)", borderColor: "rgba(245,166,35,0.4)", color: "var(--amber)" }
